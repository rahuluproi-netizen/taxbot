...
/**
 * ⚡ Performance Optimization: Batch vector upserting
 * Upserts multiple vectors into Pinecone in chunks of up to 100 vectors per API call.
...
async function upsertVectors(vectors) {
  ...
  try {
    const BATCH_SIZE = 100; // Pinecone recommended batch size for upserts
