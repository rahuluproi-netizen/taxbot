...
/**
 * Upserts multiple vectors into Pinecone using internal batching for optimal performance.
 * Ensures no more than 100 vectors are sent per Pinecone API call to prevent payload size limits.
