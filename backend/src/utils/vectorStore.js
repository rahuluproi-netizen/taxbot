...
/**
 * Upserts multiple vectors in a single batch.
 * @param {Array<{id: string, values: number[], metadata: object}>} vectors - Array of vector objects.
 */
async function upsertVectors(vectors) {
  try {
    // Pinecone handles batching naturally with the upsert call.
    // For very large datasets, further chunking could be done.
