...
/**
 * Upserts multiple vectors with their metadata into Pinecone.
 * Implements internal batching to ensure no more than 100 vectors are sent per Pinecone API call,
 * optimizing throughput and adhering to Pinecone's payload size limits.
