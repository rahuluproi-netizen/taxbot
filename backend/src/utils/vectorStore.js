...
/**
 * Upserts multiple vector objects into Pinecone in batches of up to 100 vectors per request.
 * Performance improvement: Reduces HTTP roundtrips to Pinecone from N requests to N/100 requests.
 * @param {Array<{id: string, values: number[], metadata: object}>} vectors - Array of vector items.
 */
