...
/**
 * Upserts multiple vectors with internal batching to ensure no more than 100 vectors per API call.
 * This optimizes performance and avoids Pinecone payload size limit.
 * @param {Array<{id: string, values: number[], metadata: object}>} vectors - The vectors to upsert.
 */
