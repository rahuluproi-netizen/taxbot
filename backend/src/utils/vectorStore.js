...
/**
 * Upserts multiple vectors with embeddings and metadata into Pinecone in batches.
 * Batches vectors (up to 100 per call) to avoid payload limits and reduce network latency.
