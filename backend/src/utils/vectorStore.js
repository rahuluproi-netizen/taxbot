...
/**
 * Upserts multiple vectors with their embeddings into Pinecone in batches of up to 100.
...
async function upsertVectors(vectors) {
  ...
  try {
    ...
    // Chunk vectors into batches of up to 100 to optimize Pinecone throughput
