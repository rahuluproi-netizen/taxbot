...
// Initialize Gemini chat model at the module level to avoid redundant object instantiation
...
exports.askQuery = async (req, res) => {
  try {
    ...
    // 3. Generate Answer with Gemini (using module-level initialized chatModel)
