...
exports.uploadKnowledge = async (req, res) => {
  try {
    ...
    // 1. Parse PDF
    // Performance: Using fs.promises.readFile to avoid blocking the event loop
    ...
    // Performance: Processing in batches of 100 to reduce network overhead and API calls
    ...
    // Cleanup temp file
    // Performance: Using fs.promises.unlink to avoid blocking the event loop
