...
// Initialize the chat model at the module level to prevent redundant object instantiation on each request.
...
exports.uploadKnowledge = async (req, res) => {
  try {
    ...
    // 3. Generate Embeddings & Upsert to Pinecone in batches (Optimization: reduces network roundtrips from O(N) to O(N/100))
