...
exports.uploadKnowledge = async (req, res) => {
  try {
    ...
    // 3. Generate Embeddings in batch & Upsert to Pinecone in batch
    // This optimization reduces N sequential API calls to N/BatchSize (Gemini)
    // and a single Pinecone upsert request, significantly improving throughput.
