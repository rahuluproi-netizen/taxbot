...
exports.uploadKnowledge = async (req, res) => {
  try {
    ...
    // Optimization: Generate embeddings for all text chunks in batches of 100 via Gemini batchEmbedContents,
    // and batch upsert vectors to Pinecone. Reduces API network roundtrips from O(N) to O(N/100).
