...
// Initialize Gemini SDK and the chat model at the module level to avoid redundant instantiation on each request.
...
exports.askQuery = async (req, res) => {
  try {
    ...
    // 3. Generate Answer with Gemini using the module-level chat model
