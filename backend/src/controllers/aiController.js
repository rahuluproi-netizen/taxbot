...
// Initialize models once at the module level to avoid redundant instantiation and improve response times
...
exports.uploadKnowledge = async (req, res) => {
  try {
    ...
    // 3. Generate Embeddings & Upsert to Pinecone in batch
    // This reduces API calls/network roundtrips from O(N) to O(N/100)
