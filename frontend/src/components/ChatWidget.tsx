...
export default function ChatWidget() {
  ...
  useEffect(() => {
    ...
    // Focus restoration when closing chat
        ...
        <div className="glass-panel" style={{
          ...
          <div style={{ padding: '1rem', background: 'var(--surface)', borderTop: '1px solid var(--border)', display: 'flex', gap: '0.5rem' }}>
            ...
            <button 
              ...
              disabled={loading}
              style={{ background: 'var(--primary)', color: '#fff', border: 'none', borderRadius: '50%', width: '40px', height: '40px', cursor: 'pointer', opacity: loading ? 0.7 : 1 }}
            >
              ➤
            </button>
          </div>
