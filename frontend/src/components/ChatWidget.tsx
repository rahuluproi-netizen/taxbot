    ...
    <div style={{ position: 'fixed', bottom: '2rem', right: '2rem', zIndex: 1000, fontFamily: 'inherit' }}>
      ...
      {!isOpen && (
        <button 
          ...
          aria-label="Open AI Tax Assistant chat window"
          style={{
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-modal="false"
          aria-label="AI Tax Assistant Chat"
          style={{
        ...
        >
          ...
          <div style={{ 
            ...
            <button 
              ...
              aria-label="Close AI Tax Assistant chat window"
          ...
          <div style={{ padding: '1rem', background: 'var(--surface)', borderTop: '1px solid var(--border)', display: 'flex', gap: '0.5rem' }}>
            <input 
              ...
              aria-label="Type your tax query here"
