...
export default function ChatWidget() {
  ...
  // Restore focus to toggle button when chat is closed
      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{ 
            ...
            <h2 style={{ fontWeight: 600, margin: 0, fontSize: '1rem' }}>TaxBot AI Assistant</h2>
            <button 
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem', background: 'var(--background)' }}>
            ...
            {loading && (
              <div aria-live="polite" style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                Assistant is typing...
              </div>
            )}
