...
export default function ChatWidget() {
  ...
  return (
    <div style={{ position: 'fixed', bottom: '2rem', right: '2rem', zIndex: 1000, fontFamily: 'inherit' }}>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div id="chat-widget-panel" role="region" aria-label="AI Assistant Chat" className="glass-panel" style={{
          ...
          {/* Messages */}
          <div aria-live="polite" style={{ flex: 1, overflowY: 'auto', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem', background: 'var(--background)' }}>
            {messages.map((msg, i) => (
              <div key={i} style={{
