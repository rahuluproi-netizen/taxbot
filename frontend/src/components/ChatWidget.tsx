      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{
            ...
            display: 'flex', gap: '0.5rem', opacity: loading ? 0.7 : 1,
            pointerEvents: loading ? 'none' : 'auto', transition: 'opacity 0.2s ease'
          }}>
            <input 
              ref={inputRef}
              type="text" 
              ...
              placeholder={loading ? "Assistant is thinking..." : "Type your query..."}
