...
export default function ChatPage() {
    ...
    [
      {
        role: "assistant",
        content:
          "Welcome to the Tax Assistant portal. I can help with ITR, GST, TDS, and more. What is on your mind?",
      },
    ],
  );
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ color: "var(--primary)", margin: 0, fontSize: "1.25rem" }}>
          AI Tax Assistant
        </h1>
        <button
      ...
      >
        ...
        >
          <input
            ...
            aria-label="Describe your tax query here"
            style={{
              flex: 1,
              padding: "1rem 1.5rem",
              borderRadius: "30px",
          ...
          <button
            ...
            style={{ padding: "0 2rem", borderRadius: "30px" }}
          >
            Send
          </button>
        </div>
